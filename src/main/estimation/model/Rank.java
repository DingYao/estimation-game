// estimationgame.model.Rank.java - John K. Estell - 8 May 2003
...
public class Rank implements Comparable {
    ...
    private final static java.util.List VALUES_ACE_HIGH =
            Collections.unmodifiableList(
                    Arrays.asList(TWO, THREE, FOUR, FIVE, SIX, SEVEN,
    ...
    private final static java.util.List HIGH_RANKING_CARDS =
            Collections.unmodifiableList(Arrays.asList(ACE, KING, QUEEN, JACK, TEN, NINE));

    public final static java.util.List HIGH_RANKING_VALUES =
            Collections.unmodifiableList(HIGH_RANKING_CARDS);
